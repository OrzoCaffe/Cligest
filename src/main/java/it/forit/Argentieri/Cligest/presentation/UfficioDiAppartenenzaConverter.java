...
@Named
@RequestScoped
public class UfficioDiAppartenenzaConverter implements Converter {
    @PersistenceContext
    EntityManager em;
    ...
    public Object getAsObject(FacesContext context, UIComponent component, String value) {
        ...
        try {
            return em.find(UfficioDiAppartenenza.class, Long.valueOf(value));
    ...
    public String getAsString(FacesContext context, UIComponent component, Object value) {
        ...
        if (value instanceof UfficioDiAppartenenza) {
            return String.valueOf(((UfficioDiAppartenenza) value).getId());
        } else {
